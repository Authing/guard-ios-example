...
class AppAuthViewController: UIViewController, ASWebAuthenticationPresentationContextProviding {
    ...
    let authorizationEndpoint = URL(string: "https://nativeguard.authing.cn/oidc/auth")!
    let tokenEndpoint = URL(string: "https://nativeguard.authing.cn/oidc/token")!
    let regEndpoint = URL(string: "https://nativeguard.authing.cn/oidc/reg")!
    let redirectURL = URL(string: "cn.guard://authing.cn/redirect")!
    let endPoint = URL(string: "https://nativeguard.authing.cn/login/profile/logout")!
    var idToken: String = ""
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        appDelegate.currentAuthorizationFlow =
            ...
            //            self.setAuthState(authState)
                ...
                self.tokenLabel.text = authState.lastTokenResponse?.idToken
